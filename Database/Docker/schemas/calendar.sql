...
CREATE TABLE `calendar_entries` (
  ...
  `description` text,
  `all_sensors` tinyint(1) DEFAULT NULL,
  `all_mics` tinyint(1) DEFAULT NULL,
  `mic1` tinyint(1) DEFAULT NULL,
  `mic2` tinyint(1) DEFAULT NULL,
  `mic3` tinyint(1) DEFAULT NULL,
  `all_cams` tinyint(1) DEFAULT NULL,
  `cam1` tinyint(1) DEFAULT NULL,
  `cam2` tinyint(1) DEFAULT NULL,
  `cam3` tinyint(1) DEFAULT NULL,
  `gpu` tinyint(1) DEFAULT NULL,
  `sdr` tinyint(1) DEFAULT NULL,
  `status` text,
  PRIMARY KEY (`id`)
