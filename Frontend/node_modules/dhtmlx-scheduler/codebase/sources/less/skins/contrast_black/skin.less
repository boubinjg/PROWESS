...
/*============================================================================================
                            0. Contrast Black Skin Design Default Styles
==============================================================================================*/

/* legacy vars */
@mainColor: #1b4872;
@eventBorderColor: #00b7ff;
@selectColor: #42425e;

@backColor: #000;
@monthAltBg: #2e2e2e;

@layoutFontColor: #E9E9E9;
@foreColor: #FFF;
@fontColor: @foreColor;
@default-font-color: @fontColor;
@nowDate: #423f0c;
...
@borderColor: #8d8d8d;
@lightBorderColor: #8d8d8d;

@saveBtnColor: @mainColor;
@saveBtnBorderColor: @eventBorderColor;
@regularBtnColor: #E9E9E9;
@deleteBtnColor: #ffc400;
@buttonFontSize: 14px;
...
@default-borderColor:               #8d8d8d;

/*============================================================================================
                            1. DHX Scheduler Container
==============================================================================================*/

@container-background:              rgb(0,0,0);
...
@navline-btn-top-position:                  14px;
    ...
    // ** Previous / Today / Next **
        ...
        @nav-btn-border:                    2px solid #FFF;
        @nav-btn-height:                    30px;
        @nav-btn-width:                     46px;
                    // *Prev Btn
        @nav-prev-btn-position:             61px;
        @nav-prev-btn-bg-img:               url(imgs_contrast_black/arrow_left.png);
        @nav-prev-btn-bg-position:          center center;
        @nav-prev-btn-border-radius:              5px 0 0 5px;
                    // *Next Btn
        @nav-next-btn-position:             14px;
        @nav-next-btn-bg-img:               url(imgs_contrast_black/arrow_right.png);
        ...
        @nav-today-btn-font-color:          #ffffff;
...
@col-header-top-pos:                23px;
@col-header-border-top:             1px solid #8d8d8d;
@col-header-border-right:           1px solid #8d8d8d;
@col-header-index:                  2;
@col-header-font-color:             #e9e9e9;
@col-header-font-size:              16px;

    // ** Scale Bar / column title cell

        @col-header-cell-text-align:        center;
        @col-header-cell-background:        #000;
        @col-header-cell-padding:           2px 0 0 0;
        @col-header-cell-border-left:       1px solid #8d8d8d;
        @col-header-cell-font-weight:       bold;
        @col-header-cell-font-size:         16px;
        @col-header-cell-font-color:        #e9e9e9;
...
@multi-day-border-right:            1px solid #8d8d8d;
@multi-day-border-top:              1px solid #8d8d8d;

@multi-day-icon-background:         #000;
@multi-day-icon-bg-position:        center center;
@multi-day-icon-bg-repeat:          no-repeat;

@multi-day-icon-border-bottom:      1px solid #8d8d8d;
@multi-day-icon-border-right:       1px solid #8d8d8d;
...
@event-line-background:             @mainColor;
@event-line-border:                 1px solid @eventBorderColor;
...
@scale-hour-background:             #000;
@scale-hour-border-bottom:          1px solid #8d8d8d;
...
@scale-hour-font-color:             #FFF;
@scale-hour-font-size:              16px;
...
@scale-column-border-right:         1px solid #8d8d8d;
@scale-column-background-img:       url(imgs_contrast_black/databg.png);

@scale-column-now-border-right:     1px solid #8d8d8d;
@scale-column-now-background-img:   url(imgs_contrast_black/databg.png);
@scale-column-now-background:       rgba(144,136,15,.5);
...
@data-container-border-top:         1px solid #8d8d8d;
...
// Month view / Day box
    ...
    // ** Day box Title
        ...
        @daybox-title-color:                    #e9e9e9;
        @daybox-title-background:               #000;


    // ** Day box Body

        @daybox-body-border-right:              1px solid #8d8d8d;
        @daybox-body-border-bottom:             1px solid #8d8d8d;
        @daybox-body-background:                #000;


    // ** Other month Day box Title ( Motnth that goes afret or before currently shown month )

        @other-month-daybox-title-background:   #2e2e2e;
        @other-month-daybox-title-font-color:   #e9e9e9;

    // ** Other month Day box Body

        @other-month-daybox-body-background:    #2e2e2e;
    ...
    // ** Current Day box Body 
        ...
        @current-daybox-body-background:        rgba(144,136,15,0.5);
...
==============================================================================================*/
        ...
        @event-background:                      @mainColor;
        @event-border:                          1px solid @eventBorderColor;
        @event-font-color:                      #FFFFFF;

        @event-resizer-height:                  5px; 
        @event-resizer-border-width:            0;
        @event-resizer-margin:                  -6px 0 0 2px; 
        @event-resizer-background:              @event-background url(imgs_contrast_black/resizing.png) no-repeat center center;
        ...
        @event-resizer-top-pos:                 -1px;
        
        
                // * Selected Event Menu
        
        @event-menu-head-background-img:        url(imgs_contrast_black/controls.png);
        @event-menu-head-background-pos:        1px -41px;
        @event-menu-head-border:                none;
        @event-menu-head-cursor:                default;
        @event-menu-shadow:                     0 0 1px #FFF;
        
        @event-menu-icon-background-img:        url(imgs_contrast_black/controls.png);
        @event-menu-detail-icon-bg-pos:         0px 0px;
        @event-menu-edit-icon-bg-pos:           -21px 0px;
        @event-menu-save-icon-bg-pos:           -82px -1px;
...
@modal-wrapper-opacity:                 0.2;
    ...
    @modal-popup-button-wrap-border:        2px solid #FFF;
    ...
    @modal-popup-button-font-color:         inherit;
    ...
    // ** Control OK Button 
    @modal-ok-button-wrap-border:   2px solid @eventBorderColor;
    @modal-ok-button-wrap-background:    @mainColor;
    @modal-ok-button-background:    @mainColor;
    @modal-ok-button-border:        1px solid transparent;
    @modal-ok-button-color:         #ffffff;
    @modal-ok-button-text-shadow:   none;
    
    // ** Control Cancel Button 
    @modal-cancel-button-wrap-border:   2px solid #FFFFFF;
    @modal-cancel-button-wrap-background: #000;
    @modal-cancel-button-color:         #ffffff;

    // **  Control Button:active
    @modal-popup-button-act-background:         @mainColor;
    @modal-popup-button-act-background-img:     none;
    @modal-popup-button-act-color:              #FFF;
    @modal-popup-button-act-shadow:             none;

@info-popup-background: #000;
@info-popup-font-color: @fontColor;
@info-popup-shadow: none;
@info-popup-border: 1px solid #fff;
@info-popup-inner-border: 1px solid #fff;
/*============================================================================================
                            1. DHX Scheduler Container
==============================================================================================*/
...
@infobox-font-size:             8pt;
    ...
    @infobox-content-padding-top-bottom:16px;
    @infobox-content-padding-left-right:8px;
    @infobox-content-padding:           @infobox-content-padding-top-bottom @infobox-content-padding-left-right;
    @infobox-content-padding-rtl:       @infobox-content-padding-top-bottom @infobox-content-padding-left-right;
    ...
    @infobox-control-btn-padding-left:  5px;
...
@lightbox-border:       1px solid #8d8d8d;
@lightbox-border-radius:      5px;
@lightbox-font-color:   #fff;
@lightbox-font-family:  @secondary-font-family;
@lightbox-font-size:    14px;
@lightbox-shadow-x:     5px;
@lightbox-shadow-y:     5px;
@lightbox-shadow-radius:5px;
@lightbox-shadow-color: #888;
@lightbox-shadow:       @lightbox-shadow-x @lightbox-shadow-y @lightbox-shadow-radius @lightbox-shadow-color;
@lightbox-shadow-rtl:   -@lightbox-shadow-x @lightbox-shadow-y @lightbox-shadow-radius @lightbox-shadow-color;
    ...
    @lightbox-title-time-padding-rtl:       0 10px 0 0;
    ...
    @lightbox-area-wrap-background:         #000;
    ...
    @lightbox-area-ls-background:           rgb(0,0,0);
    @lightbox-area-ls-font-color:           #FFF;
    ...
    @lightbox-ls-fullday-font-color:        #FFF;
    ...
    @lightbox-area-rs-padding-top:          2px;
    @lightbox-area-rs-padding-right:        0px;
    @lightbox-area-rs-padding-bottom:       2px;
    @lightbox-area-rs-padding-left:         10px;
    ...
    @lightbox-responsive-repeat-text-back:#000;
    ...
    @lightbox-area-rs-select-padding-left:  2px;
    ...
    @lightbox-area-rs-select-margin-top:    0px;
    @lightbox-area-rs-select-margin-right:  0px;
    @lightbox-area-rs-select-margin-bottom: 0px;
    @lightbox-area-rs-select-margin-left:   0px;
    ...
    @lightbox-input-radio-margin-top:       3px;
    @lightbox-input-radio-margin-right:     3px;
    ...
    @lightbox-btn-border:                   1px solid rgb(206, 206, 206);
    ...
    @lightbox-del-btn-border:               1px solid #ffc400;
    @lightbox-del-btn-background:           #000;
    @lightbox-del-btn-font-color:           #ffc400;
    @lightbox-del-btn-text-shadow:          none;
    @lightbox-del-btn-margin:               12px 20px 0 20px;
    @lightbox-btn-recurring-bg-image: url(./imgs_contrast_black/but_repeat.gif);

    @lightbox-save-btn-border:              2px solid @eventBorderColor ~'!important';
    @lightbox-save-btn-color:               #FFFFFF;
    @lightbox-save-text-shadow:             none;
    @lightbox-save-btn-background:          @mainColor;
...
// Other
	...
	@grid-tree-cell-font-size:              inherit;


    @calendar-open-icon: url(./imgs_contrast_black/calendar.gif);

    // ** Mini Calendar 

    @mini-calendar-border-color:            #8d8d8d;
    @mini-calendar-font-color:              #000;
    ...
    @agenda-topline-font-color:         #fff;
    @agenda-data-background-image:      url(./imgs_contrast_black/databg.png);
    @map-data-bg: url(./imgs_contrast_black/databg.png);
    @year-tooltip-bg-image: url(imgs_contrast_black/databg.png);