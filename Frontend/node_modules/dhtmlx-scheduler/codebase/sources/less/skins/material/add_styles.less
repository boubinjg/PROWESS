...
.dhx_cal_container, .dhtmlx_modal_box, .dhtmlx_message_area, .dhx_cal_light, .dhtmlXTooltip {
...
.dhx_btn_set {
	float:left/@lightbox-save-btn-float;
}
...
// _____________________________ End Of Various Elements  _____________________________
...
//	2.2 Navigation Button Hover
.dhx_cal_navline .dhx_cal_today_button {
	border-radius: 2px;
	&:hover {
		border: @nav-today-btn-hov-border;
		background-color: @nav-today-btn-hov-background;
...
.dhx_cal_navline .dhx_cal_prev_button {
	...
	&:hover {
		background-color: @nav-prev-btn-hov-background;
		border-radius: 50%;
	}
}
...
.dhx_cal_navline .dhx_cal_next_button {
	...
	&:hover {
		background-color: @nav-next-btn-hov-background;
		border-radius: 50%;
	}
}
...
.dhx_cal_tab {
	&:hover {
		background-color:  @nav-tab-hov-background;
	}
}
...
// _____________________________ End Of Navigation Bar and It's Elements  _____________________________
...
.dhx_scale_holder .dhx_cal_event .dhx_header, .dhx_scale_holder .dhx_cal_event .dhx_title, .dhx_scale_holder .dhx_cal_event .dhx_body, .dhx_scale_holder .dhx_cal_event .dhx_footer {
	width:100%;
	box-sizing: border-box;
...
.dhx_cal_event.dhx_cal_editor {
	box-shadow: none;
	background-color: @event-editor-background;
	min-height: 24px;
	box-shadow: 1px 1px 0 0 rgba(255, 255, 255, 0.47);
}
...
// _____________________________ End Of Event and It's Elements  _____________________________
...
// 4.1 Data Column Header/Title
.dhx_cal_scale_placeholder{
	position: absolute;
	z-index: 2;
	box-shadow: @multi-day-shadow;
	left: 0;
}
...
.dhx_matrix_scell.folder.closed .dhx_scell_expand{
	...
	&:after {
		...
		height: 100%;
		width: 13px;
		background: #ebeced @treemode-expand-icon-bg-image no-repeat;
...
.dhx_row_folder .dhx_data_table .dhx_matrix_cell{
	background-color: @grid-tree-folder-cell-bg;
	cursor: pointer;
}
...
.dhx_row_folder {
	...
	.dhx_data_table .dhx_matrix_cell {
...
.dhx_scale_bar.undefined:last-child {
	border-right: 1px solid @default-border-color!important;
}
...
// 4.3 Timeline tooltip

.dhtmlXTooltip.tooltip{
	border-left: @tooltip-border-left;
	border-top: @tooltip-border-top;
...
.dhx_cal_header .dhx_cal_prev_button {
	...
	&:hover {
		background-image: @nav-prev-btn-hov-bg-img;
...
.dhx_cal_header .dhx_cal_next_button {
	&:hover {
		background-image:@nav-next-btn-hov-bg-img;
	}
}
// _____________________________ End Of Data section and It's Elements  _____________________________
...
.dhtmlx_popup_button.dhtmlx_ok_button:active div {
	color: @modal-ok-button-color;
}

.dhtmlx_message_area .dhtmlx-error{
	box-shadow: @info-popup-shadow;
}
...
.dhx_cal_container.dhx_mini_calendar {
	...
	border-radius: 0px;
	font-family: @mini-calendar-font-family;
	padding:5px;
}
...
.dhx_mini_calendar .dhx_year_month {
	...
	color: @mini-calendar-header-font-color;
	line-height: 20px;
	font-size: @mini-calendar-header-font-size;
	font-weight: @mini-calendar-header-font-weight;
}
...
.dhx_mini_calendar .dhx_scale_bar{
	font-family: @mini-calendar-font-family;
	font-size: @mini-calendar-weekday-font-size;
	font-weight: @mini-calendar-weekday-font-weight;
	border-width: 0;
}
...
.dhx_mini_calendar .dhx_month_head {
	font-size: @mini-calendar-date-font-size;
	font-weight: @mini-calendar-date-font-weight;
	color: @mini-calendar-date-font-color;
	margin:2px 2px;
	border-radius: 50%;
	padding: 5px 0 0 1px;
	text-align: center;
	box-sizing: border-box;
	height: @mini-calendar-date-height;
	width: @mini-calendar-date-width;
}
...
// End of Calendar
 ...
 // Modal Pop up - Series Event edition
 .dhtmlx_modal_box.dhtmlx-alert .dhtmlx_edit_series_button {
	float: right;
	text-align: center;
	text-transform: uppercase;
	padding: @alertbox-series-btn-padding;
	border: @alertbox-series-btn-border;
	background-color:  @alertbox-series-btn-background;

	div {
		border: 1px solid @base-color;
		background-color: @base-color;
		color: @alertbox-series-btn-font-color;
	}
...
.dhtmlx_modal_box.dhtmlx-alert .dhtmlx_edit_occurrence_button {
	...
	text-align: center;
	text-transform: uppercase;
	padding: @alertbox-occur-btn-padding;
	border: @alertbox-occur-btn-border;
	background-color:  @alertbox-occur-btn-background;

	div {
		border: 1px solid #fff;
		background-color: #fff;
		color: @alertbox-occur-btn-font-color;
	}

	&:hover {
		background-color: @lightbox-btn-hov-background;
		transition: all 0.1s ease-in-out;
		border: @lightbox-btn-hov-border;
...
.dhx_qi_big_icon:hover{
	...
	background-color: @modal-popup-button-hov-color;
	transition: all .1s ease-in-out;
}
...
.dhx_qi_big_icon.icon_delete{
	color:@lightbox-del-btn-font-color;
}
...
// _____________________________ End Of Modal Pop-Ups and It's Elements  _____________________________
...
.dhx_cal_light{
	select, input, textarea, .combo>div{
		border-radius:2px;
	}
}
...
.dhx_cal_light input {
	...
	padding: @lightbox-input-padding
}
...
.dhx_cal_title {
	border-radius: @lightbox-title-border-radius;
	margin: @lightbox-title-margin;
}
...
textarea.dhx_cal_editor {
	box-sizing: border-box;
	color: @event-editor-font-color;
	font-weight: @event-editor-font-weight;
	resize: none;
}
...
.dhx_section_time select.dhx_lightbox_time_select {
	...
	background: url(imgs_dhx_material/time.svg) no-repeat  8px 5px,
				url(imgs_dhx_material/menu-down.svg) no-repeat 100% 3px;
...
.dhx_cal_light_rtl .dhx_section_time select.dhx_lightbox_time_select {
	background: url(imgs_dhx_material/time.svg) no-repeat  75px 5px,
				url(imgs_dhx_material/menu-down.svg) no-repeat left !important;	
}
...
.dhx_time{
	color: @lightbox-title-time-font-color;
}

.dhx_in_move {
	background-color: @event-inmove-background;
	color: @event-inmove-font-color;
}
...
.dhx_cal_light select {
	...
	appearance: none;
	background: url(imgs_dhx_material/menu-down.svg) no-repeat 100% 3px;
	border: @lightbox-area-rs-select-border;
}
.dhx_cal_light.dhx_cal_light_rtl {
    select {
...
.dhx_cal_light_wide .combo > div{
	top: @lightbox-combo-input-top;
}

.dhx_cal_light_wide .dhx_combo_box, .dhx_cal_light_wide .combo > div {
...
.dhx_cal_lsection .dhx_fullday input[type="checkbox"]  {
	margin: @lightbox-ls-fullday-input-margin;
	vertical-align:middle;
}
/*
...
.dhx_delete_btn_set {
	float: left;
	&:hover {
		border: @lightbox-del-btn-hov-border;
		background-color: @lightbox-del-btn-hov-background;
	}
}
...
.dhx_lightbox_minical.dhx_section_time select{
 ...
 .dhtmlx_cancel_button:hover {
	...
	& div {
		background-color: @modal-popup-button-hov-color;
		border-color: @modal-popup-button-hov-color;
		transition: all 0.1s ease-in-out;
	}
}
...
.dhtmlx_popup_button.dhtmlx_ok_button {
	...
	&:hover {
		border-color: darken(#FF584C, 15);
		transition: all .1s ease-in-out;

		div {
			background-color: darken(#FF584C, 15);;
			border-color: darken(#FF584C, 15);
			transition: all .1s ease-in-out;
		}
	}
...
.dhx_section_time.dhx_section_time_calendar {
	& select {
		width: 64px;
	}
}
...
@media only screen and (max-width: 1023px) {
	...
	.dhx_cal_light.dhx_cal_light_responsive {
		...
		select, .dhx_section_time select.dhx_lightbox_time_select {
		...
		.dhx_section_time select.dhx_lightbox_time_select {
			...
			background: url(imgs_dhx_material/time.svg) no-repeat  0.781vw 0.488vw,
						url(imgs_dhx_material/menu-down.svg) no-repeat 100% 0.293vw;
		}
...
// _____________________________ End Of Lightbox and It's Elements  _____________________________
...
// End OF Year View - Event tooltip


// _____________________________ End Of YEAR CALENDAR and It's Elements  _____________________________
...
.dhx_agenda_area div[role="row"]:nth-child(even) {
	background-color: @agenda-even-data-background;
}
...
.dhx_scheduler_week_agenda .dhx_wa_column {
	font-family: @week-agenda-font-family;
	font-size: 14px;
	color: @week-agenda-font-color;
}
...
.dhx_scheduler_week_agenda .dhx_wa_scale_bar {
	...
	font-weight: 500;
	color: inherit;
	border-top: @week-agenda-border;
	border-bottom: @week-agenda-border;
	background-color: @week-agenda-header-background;
	padding-left:7px;
}
...
.dhx_wa_column.dhx_wa_column_last .dhx_wa_day_cont {
	border-left: @week-agenda-border;
}

.dhx_scheduler_week_agenda .dhx_cal_event_selected{
    background-color: @week-agenda-selected-background;
    color: white;
}
// _____________________________ End Of Agenda and It's Elements  _____________________________
