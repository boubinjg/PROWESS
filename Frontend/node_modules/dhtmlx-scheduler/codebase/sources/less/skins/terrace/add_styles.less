...
.dhx_cal_lsection, .dhx_cal_light_wide .dhx_cal_lsection .dhx_fullday, .dhx_cal_lsection .dhx_fullday {
	color: #747473;
	// border-width: 1px;
	// padding: 0 2px 0 2px;
}
...
.dhx_cal_container_rtl .dhx_v_border, .dhx_cal_container_rtl .dhx_agenda_line div{
	border-right: 0;
	border-left: 1px solid #CECECE;
}
