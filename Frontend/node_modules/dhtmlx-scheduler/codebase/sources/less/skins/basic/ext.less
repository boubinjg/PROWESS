...
.dhx_scale_bar_header {
    position: absolute;
    border-bottom: 1px dotted rgb(163, 149, 136);
    width: 100%;
}
.dhx_expand_icon {
...
.dhx_scheduler_agenda .dhx_cal_data {
	background-image: @agenda-data-background-image;
}
.dhx_agenda_area{
	width:100%;
	overflow-y:auto;
...
.dhx_year_body .dhx_before .dhx_month_head, .dhx_year_body .dhx_after .dhx_month_head, .dhx_year_body .dhx_before .dhx_month_head a, .dhx_year_body .dhx_after .dhx_month_head a{
  color: @mini-calendar-other-date-color;
}
...
.dhx_month_head.dhx_year_event{
  background-color: @mini-calendar-year-event-bg;
  color: @mini-calendar-year-event-color;
}
...
.dhx_year_tooltip{
  ...
  background-image:@year-tooltip-bg-image;
  position:absolute;
  z-index:12;
  width:300px; 
  height:auto;
...
.dhx_text_disabled{
	color: @lightbox-rs-disabled-font-color;
	font-family: @lightbox-rs-disabled-font-family;
	font-size: @lightbox-rs-disabled-font-size;
}
...
.dhx_mini_calendar .dhx_calendar_click{
	background-color: @mini-calendar-date-clicked-bg;
}
.dhx_cal_navline div.dhx_minical_icon {
	...
	top:1px;
	cursor:pointer;
	background: @calendar-open-icon  no-repeat;
}
...
.dhx_timeline_scale_header {
	height: 100%;
	font-family: @grid-tree-cell-font-family;
	font-size: @grid-tree-cell-font-size;
	color: @grid-tree-cell-font-color;
	font-weight: 500;
}
...
.dhx_matrix_cell, .dhx_matrix_scell{
	...
	text-align:center;
	vertical-align:middle;
	border-bottom: @grid-border-bottom;
	border-right: @grid-border-right;	
}
.dhx_cal_container_rtl .dhx_matrix_cell, 
.dhx_cal_container_rtl .dhx_matrix_scell{
	border-right: unset;
	border-left: @grid-border-right;	
}
.dhx_timeline_scale_header{
	border-right: @col-header-cell-border-left;	
}
...
.dhx_cal_event_line .dhx_event_resize {
	cursor: w-resize;
	cursor: ew-resize;
	background: @event-line-resize-icon;
	position: absolute;
	top: 0;
	width: 4px;
	height: 100%;
...
.dhx_now_time {
	width:100%;
	border-bottom:2px solid @now-line-color;
}

.dhx_scheduler_month .dhx_now_time {
	border-bottom: 0;
	border-left: 2px solid @now-line-color;
}
...
.dhx_now_time, .dhx_matrix_now_time{
	opacity: 0.5;
}
/* now time End */
...
.dhx_cal_quick_info {
	...
	position: absolute;
	z-index: 8;
	font-family: @infobox-font-family;
	font-size: @infobox-font-size;
	background-color: @infobox-background;
	padding: @infobox-padding;
	width: @infobox-width;
	transition: @infobox-transition;
	-moz-transition: @infobox-transition;
	-webkit-transition: @infobox-transition;
	-o-transition: @infobox-transition;
}
...
.dhx_cal_qi_title{
	...
	letter-spacing: @infobox-letter-spacing;
}

.dhx_cal_container_rtl .dhx_cal_qi_title{
	padding: @infobox-title-padding-rtl;
	text-align: right;
}

.dhx_cal_qi_tdate{
	font-size: @infobox-title-date-font-size;
}

.dhx_cal_qi_tcontent{
	font-size:@infobox-title-cont-font-size;
	font-weight: @infobox-title-cont-font-weight;
}
...
.dhx_cal_qi_content {
	...
	padding: @infobox-content-padding;
	font-size: @infobox-content-font-size;
	color: @infobox-content-font-color;
	width: @infobox-content-width;
	overflow: hidden;
}

.dhx_quick_info_rtl .dhx_cal_qi_content {
	padding: @infobox-content-padding-rtl;
	direction: rtl;
}

.dhx_qi_big_icon {
	min-width: @infobox-control-btn-min-width;
	padding: @infobox-control-btn-padding;
	margin: @infobox-control-btn-margin;
	background-color: @infobox-control-btn-bg-color;
	border-bottom: @infobox-control-btn-border-bottom;
	border-right: @infobox-control-btn-border-right;
	border-radius: @infobox-control-btn-border-radius;
	line-height:@infobox-control-btn-lheight;
	color: @infobox-control-btn-font-color;
	vertical-align: @infobox-control-btn-vertical-align;
	cursor:pointer;
	float:left;
}

.dhx_quick_info_rtl .dhx_qi_big_icon {
	padding: @infobox-control-btn-padding-rtl;
	margin: @infobox-control-btn-margin-rtl;
}

.dhx_cal_qi_controls div{
	float: left;
	height: @infobox-control-btn-height;
	text-align: center;
	line-height: @infobox-control-btn-lheight;
}
...
// .dhx_quick_info_rtl .dhx_cal_qi_controls{
// 	direction: unset;
// 	float: left;
// }
...
.dhx_drag_marker{
	...
	background-color: @scale-time-drag-maker-background;
	position: absolute;
...
/* key nav */
.dhx_focus_slot{
	background: @section-focus-background;
	position:absolute;
	pointer-events: none;
	opacity: 0.3;
}
...
.dhx_cal_container *:focus {
	outline-style: solid;/*not visible focus outline in ie11*/
	outline-style: auto;
}
