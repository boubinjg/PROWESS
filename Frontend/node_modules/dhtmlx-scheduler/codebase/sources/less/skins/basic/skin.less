...
@navline-height:                            20px;
    ...
    // ** Previous / Today / Next **
        ...
        @nav-prev-btn-resp-left-position:   20px;
        @nav-prev-btn-resp-right-position:  auto;
        ...
        @nav-today-btn-resp-right-position: 0;
        @nav-today-btn-resp-top-position:   50px !important;
...
@nav-tab-font-size:inherit;
        ...
        @nav-tab-border-color:              transparent;
        @nav-tab-border:                    none;
        ...
        @nav-tab-responsive-top:            50px !important;
...
@event-line-padding-top:            0;
@event-line-padding-right:          0;
@event-line-padding-bottom:         0;
@event-line-padding-left:           10px;
@event-line-padding-right-rtl:      9px;
@event-line-padding:                @event-line-padding-top @event-line-padding-right @event-line-padding-bottom @event-line-padding-left;
@event-line-padding-rtl:            @event-line-padding-top @event-line-padding-right-rtl @event-line-padding-bottom @event-line-padding-right;
...
// Month view / Day box
    ...
    // ** Day box Title
        ...
        @daybox-title-padding-top:              3px;
        @daybox-title-padding-right:            5px;
        @daybox-title-padding-bottom:           0;
        @daybox-title-padding-left:             0;
        @daybox-title-padding:                  @daybox-title-padding-top @daybox-title-padding-right @daybox-title-padding-bottom @daybox-title-padding-left;   // double check if we need this 5px padding
...
@event-title-text-align-rtl:            center;
@event-title-padding-top:               0;
...
@event-menu-head-margin-left:           5px;
@event-menu-head-margin-right:          0;
@event-menu-head-margin-left-rtl:       @event-menu-head-margin-right;
@event-menu-head-margin-right-rtl:      @event-menu-head-margin-left;
@event-menu-icon-margin-left:           -5px;
@event-menu-icon-margin-right:          0;
@event-menu-icon-margin-left-rtl:       @event-menu-icon-margin-right;
@event-menu-icon-margin-right-rtl:      @event-menu-icon-margin-left + 2px;
...
@infobox-font-size:             8pt;
    ...
    @infobox-content-padding-right-left:8px;
    @infobox-content-padding:           @infobox-content-padding-top-bottom @infobox-content-padding-right-left;
    @infobox-content-padding-rtl:       @infobox-content-padding-top-bottom @infobox-content-padding-right-left;
...
@lightbox-responsive-form-repeat-width: 70vw !important;
@lightbox-responsive-repeat-label-padding: 1.465vw;

    // **LightBox title

    @lightbox-title-padding-top:            2px;
    @lightbox-title-padding-right:          0;
    @lightbox-title-padding-bottom:         2px;
    @lightbox-title-padding-left:           5px;
    ...
    @lightbox-title-name-padding-left:      10px;
...
// ** LightBox Main Area
    ...
    @lightbox-area-ls-margin-left:          0;
    ...
    @lightbox-responsive-ls-margin-right:   2.93vw;
    ...
    @lightbox-area-textarea-rs-padding-top: 2px;
    @lightbox-area-textarea-rs-padding-right:2px;
    @lightbox-area-textarea-rs-padding-bottom:2px;
    @lightbox-area-textarea-rs-padding-left:2px;
    ...
    @lightbox-responsive-repeat-text-border:1px solid #CECECE;
    @lightbox-responsive-repeat-text-back:#F9F9F9;
    ...
    @lightbox-input-label-margin-top:       0;
    @lightbox-input-label-margin-right:     0;
    @lightbox-input-label-margin-bottom:    0;
    @lightbox-input-label-margin-left:      0;
    ...
    @ligthbox-responsive-month-select-width:20.508vw !important;
    @lightbox-responsive-year-select-width: 13.672vw !important;
    ...
    @lightbox-responsive-btn-rec-padding-top:0.977vw;
    @lightbox-responsive-btn-rec-padding-right:4.492vw;
    @lightbox-responsive-btn-rec-padding-bottom:0.977vw;
    @lightbox-responsive-btn-rec-padding-left:1.563vw;
    @lightbox-responsive-btn-rec-padding:   @lightbox-responsive-btn-rec-padding-top @lightbox-responsive-btn-rec-padding-right @lightbox-responsive-btn-rec-padding-bottom @lightbox-responsive-btn-rec-padding-left;
    @ligthbox-responsive-recurring-btn-div-padding:1.953vw !important;
