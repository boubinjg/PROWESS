...
.dhx_cal_container_rtl .dhx_cal_event .dhx_title {
	text-align: @event-title-text-align-rtl;
	padding: @event-title-padding-rtl;
	// direction: ltr;
}
...
.dhx_cal_container_rtl .dhx_cal_event .dhx_body {
	padding: @event-body-padding-rtl;
}
...
.dhx_cal_container_rtl .dhx_cal_event_line {
	padding:@event-line-padding-rtl;
}
...
.dhx_cal_container_rtl .dhx_cal_event_line_start{
	border-top-left-radius: @event-line-border-radius;
	border-bottom-left-radius: @event-line-border-radius;
}
...
.dhx_cal_container_rtl .dhx_cal_event_line_end{
	border-top-right-radius: @event-line-border-radius;
	border-bottom-right-radius: @event-line-border-radius;
}
...
div.dhx_menu_head{
	...
	margin-left:@event-menu-head-margin-left; 
...
.dhx_cal_container_rtl div.dhx_menu_head {
	margin-left:@event-menu-head-margin-left-rtl;
	margin-right:@event-menu-head-margin-right-rtl;
}

div.dhx_menu_icon{
	background-image:@event-menu-icon-background-img;
	width:20px; height:20px;
	margin-left:@event-menu-icon-margin-left; 
	margin-top:0px;
	border:none;
	cursor:pointer;
}
...
.dhx_cal_container_rtl div.dhx_menu_icon {
	margin-left:@event-menu-icon-margin-left-rtl;
	margin-right:@event-menu-icon-margin-right-rtl;
}
