...
.dhtmlx_modal_box {
  ...
  box-shadow: inset 0px 0px 0px 4px #1b4872;
...
.dhx_cal_event .dhx_select_menu_footer {
  ...
  position: relative;
  top: -1px;
  background: #1b4872 url(imgs_contrast_black/resizing.png) no-repeat center center;
}
...
.dhx_scheduler_agenda .dhx_cal_data {
  background-image: url(./imgs_contrast_black/databg.png);
}
.dhx_agenda_area {
  width: 100%;
  overflow-y: auto;
...
.dhx_cal_prev_button {
  ...
  background-image: url(imgs_contrast_black/arrow_left.png);
...
.dhx_cal_next_button {
  ...
  right: 14px;
  background-color: none;
  background-image: url(imgs_contrast_black/arrow_right.png);
  background-position: center center;
  background-repeat: no-repeat;
  height: 30px;
  width: 46px;
...
.dhx_now .dhx_month_body {
  background-color: rgba(144, 136, 15, 0.5);
}
.dhx_now .dhx_month_head {
  background-color: rgba(144, 136, 15, 0.5);
}
...
.dhx_custom_button_recurring {
  background-image: url(./imgs_contrast_black/but_repeat.gif);
...
.dhx_cal_quick_info {
  background: #000000;
  border: 1px solid #FFF;
  -webkit-box-shadow: inset 0px 0px 0px 4px #1b4872;
  -moz-box-shadow: inset 0px 0px 0px 4px #1b4872;
  box-shadow: inset 0px 0px 0px 4px #1b4872;
  padding: 4px;
}
.dhx_cal_qi_title {
