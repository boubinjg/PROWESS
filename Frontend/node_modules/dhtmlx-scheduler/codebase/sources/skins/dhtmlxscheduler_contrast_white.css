...
.dhx_cal_navline div.dhx_minical_icon {
  ...
  top: 1px;
  cursor: pointer;
  background: url(./imgs_contrast_white/calendar.gif) no-repeat;
}
.dhx_grid_rtl {
  direction: rtl;
}
...
.dhx_cal_event .dhx_body,
.dhx_cal_event .dhx_title {
  background-color: #a8b2f5;
  border-color: #677cfb;
  color: #000000;
}
.dhx_cal_event.dhx_cal_editor {
  border: 1px solid #677cfb;
}
.dhx_cal_editor {
  font-size: 16px;
...
.dhx_cal_quick_info {
  background: #FFF;
  border: 1px solid #585858;
  -webkit-box-shadow: inset 0px 0px 0px 4px #585858;
  -moz-box-shadow: inset 0px 0px 0px 4px #585858;
  box-shadow: inset 0px 0px 0px 4px #585858;
  padding: 4px;
}
.dhx_cal_qi_title {
