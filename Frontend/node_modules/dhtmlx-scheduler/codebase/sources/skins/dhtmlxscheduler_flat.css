...
.dhx_cal_event .dhx_select_menu_footer {
  ...
  position: relative;
  top: auto;
  background: transparent url(imgs_flat/resizing.png) center center no-repeat !important;
}
...
.dhx_cal_prev_button {
  ...
  background-image: url(imgs_flat/arrow_left.png);
...
.dhx_cal_next_button {
  ...
  right: 14px;
  background-color: none;
  background-image: url(imgs_flat/arrow_right.png);
  background-position: center center;
  background-repeat: no-repeat;
  height: 30px;
  width: 46px;
