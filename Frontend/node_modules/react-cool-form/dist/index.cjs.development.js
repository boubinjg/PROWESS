...
var useState = (function (initialState, onChange) {
  ...
  var stateObserversRef = react.useRef([{
    usedState: {},
    update: forceUpdate
  }]);
  ...
  var setUsedState = react.useCallback(function (usedState) {
    stateObserversRef.current[0].usedState = usedState;
  }, []);
  var subscribeObserver = react.useCallback(function (observer) {
    return stateObserversRef.current.push(observer);
  }, []);
  var unsubscribeObserver = react.useCallback(function (observer) {
...
var useForm = (function (_temp) {
  ...
  var controlledsRef = react.useRef({});
  ...
  var handleUnset = react.useCallback(function (path) {
  ...
  var setNodesOrStateValue = react.useCallback(function (values, _temp2) {
  ...
  var getFormState = react.useCallback(function (path, _ref3) {
  ...
  var select = react.useCallback(function (path, _temp3) {
  ...
  var getState = react.useCallback(function (path, target) {
    return getFormState(path, {
      target: target
    });
  }, [getFormState]);
  ...
  var setDirtyIfNeeded = react.useCallback(function (name) {
    return setDirty(name, !lite.dequal(get(stateRef.current.values, name), get(initialStateRef.current.values, name)));
  }, [setDirty, stateRef]);
  var setValue = react.useCallback(function (name, value, _temp4) {
  ...
  var submit = react.useCallback(async function (e) {
    if (e != null && e.preventDefault) e.preventDefault();
    if (e != null && e.stopPropagation) e.stopPropagation();
    var nextTouched = Object.keys(_extends__default['default']({}, fieldsRef.current, controlledsRef.current)).reduce(function (touched, name) {
  ...
  var removeField = react.useCallback(function (name) {
    handleUnset("values." + name);
    handleUnset("touched." + name);
    handleUnset("dirty." + name);
    handleUnset("errors." + name);
  ...
  var registerField = react.useCallback(function (validateOrOptions) {
...
var useFormState = (function (path, _temp) {
  var _ref = _temp === void 0 ? {} : _temp,
      formId = _ref.formId,
      rest = _objectWithoutPropertiesLoose__default['default'](_ref, ["formId"]);
  ...
  return getFormState(path, _extends__default['default']({}, rest, {
...
var useControlled = (function (name, _temp) {
  ...
  var _ref = _temp === void 0 ? {} : _temp,
      ...
      props = _objectWithoutPropertiesLoose__default['default'](_ref, ["formId", "defaultValue", "validate", "parse", "format", "errorWithTouched"]);
  ...
  var hasWarn = react.useRef(false);
  ...
  var _onChange = props.onChange,
      ...
      restProps = _objectWithoutPropertiesLoose__default['default'](props, ["onChange", "onBlur"]);
