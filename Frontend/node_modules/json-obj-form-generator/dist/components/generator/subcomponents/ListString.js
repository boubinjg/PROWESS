...
exports.prototype = exports.validGetArrays = exports.ListString = void 0;
...
var ListString = /*#__PURE__*/function (_Component) {
  _inherits(ListString, _Component);

  var _super = _createSuper(ListString);

  function ListString() {
    var _this;

    _classCallCheck(this, ListString);
    ...
    _defineProperty(_assertThisInitialized(_this), "state", {
      gId: (0, _utils.idGenerator)(_this.props.jkey.prefix + "-lstr-" + _this.props.jkey.sufix)
    });
    ...
    value: function render() {
      ...
      if (this.props.value.values.length < this.props.max) {
        new_element = /*#__PURE__*/_react.default.createElement(_react.Fragment, null, /*#__PURE__*/_react.default.createElement(_reactstrap.FormGroup, {
          ...
          color: "danger"
        }, this.props.err_minlength), /*#__PURE__*/_react.default.createElement(_reactstrap.FormFeedback, {
          hidden: this.props.value.new_max,
          color: "danger"
        }, this.props.err_maxlength)), /*#__PURE__*/_react.default.createElement("td", {
          className: "btns"
      ...
      return /*#__PURE__*/_react.default.createElement("div", {
        ...
        return /*#__PURE__*/_react.default.createElement(_reactTransitionGroup.CSSTransition, {
          ...
          value: item,
          invalid: !_this2.props.value.emin[idx] || !_this2.props.value.emax[idx],
          onChange: _this2.onChange
        }), /*#__PURE__*/_react.default.createElement(_reactstrap.FormFeedback, {
          hidden: _this2.props.value.emin[idx],
          color: "danger"
        }, _this2.props.err_minlength), /*#__PURE__*/_react.default.createElement(_reactstrap.FormFeedback, {
          hidden: _this2.props.value.emax[idx],
          color: "danger"
        }, _this2.props.err_maxlength)), /*#__PURE__*/_react.default.createElement("td", {
          className: "btns"
        }, /*#__PURE__*/_react.default.createElement(_reactstrap.Button, {
...
ListString.propTypes = {
  ...
  minLength: function minLength(props, propName, componentName) {
  ...
  maxLength: function maxLength(props, propName, componentName) {
    if (props[propName] !== undefined) {
      if (!(0, _validators.intValid)(String(props[propName]))) {
        return new Error('Invalid prop `' + propName + '` supplied to' + ' `' + componentName + '`. Value must be integer.');
      }
  ...
  err_minlength: _propTypes.default.string,
  err_maxlength: _propTypes.default.string,
...
var validGetArrays = function validGetArrays(e, props) {
  ...
  var emin = [];
  var emax = [];
  var minL = props.minLength === undefined || !(0, _validators.intValid)(props.minLength) ? 0 : (0, _validators.filterInt)(props.minLength);
  var maxL = props.maxLength === undefined || !(0, _validators.intValid)(props.maxLength) ? Infinity : (0, _validators.filterInt)(props.maxLength);
