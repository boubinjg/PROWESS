...
exports.getValue = exports.getErrors = exports.InputListCustom = void 0;
...
var InputListCustom = /*#__PURE__*/function (_Component) {
  ...
  function InputListCustom() {
    ...
    _defineProperty(_assertThisInitialized(_this), "onDrop", function (e) {
      ...
      err.err_minNo = !this.props.required && val === null || this.props.minNo !== undefined && (0, _validators.intValid)(this.props.minNo) && (0, _validators.filterInt)(this.props.minNo) > val.length;
      err.err_maxNo = this.props.maxNo !== undefined && (0, _validators.intValid)(this.props.maxNo) && (0, _validators.filterInt)(this.props.maxNo) < val.length;
      ...
      if (val.length === 0 && this.props.required && this.props.default && this.props.minNo !== undefined && this.props.minNo > 0) {
        err.warn_def = true;
        var err_minNo = this.props.minNo !== undefined && (0, _validators.intValid)(this.props.minNo) && (0, _validators.filterInt)(this.props.minNo) > this.props.default.length;
        var err_maxNo = this.props.maxNo !== undefined && (0, _validators.intValid)(this.props.maxNo) && (0, _validators.filterInt)(this.props.maxNo) < this.props.default.length;
    ...
    value: function render() {
      ...
      if (this.props.value === null || this.props.value !== null && (!(0, _validators.intValid)(this.props.maxNo) || (0, _validators.filterInt)(this.props.maxNo) > this.props.value.length)) {
        new_element = /*#__PURE__*/_react.default.createElement(_react.Fragment, null, /*#__PURE__*/_react.default.createElement(_reactstrap.FormGroup, {
          ...
          hidden: this.props.errors.new_rgx,
          color: "danger"
      ...
      return /*#__PURE__*/_react.default.createElement("div", {
        ...
        return /*#__PURE__*/_react.default.createElement(_reactTransitionGroup.CSSTransition, {
          ...
          hidden: _this2.props.errors.ergx[idx],
          color: "danger"
...
InputListCustom.propTypes = {
  ...
  default: _propTypes.default.arrayOf(_propTypes.default.string),
  ...
  regex: function regex(props, propName, componentName) {
    if (props[propName] !== undefined) {
      try {
        ...
        return new Error("Invalid prop `".concat(propName, "` supplied to `").concat(componentName, "`. Invalid regular expression."));
      }
    }
  },
  ...
  invalidRGX: _propTypes.default.string
};
...
var getErrors = function getErrors(e, props) {
  ...
  if (new_value !== undefined && new_value !== null) {
    ...
    if (!warn_def) {
      var sinvalid = [];
      var err_minNo = props.minNo !== undefined && (0, _validators.intValid)(props.minNo) && (0, _validators.filterInt)(props.minNo) > props.default.length;
      var err_maxNo = props.maxNo !== undefined && (0, _validators.intValid)(props.maxNo) && (0, _validators.filterInt)(props.maxNo) < props.default.length;
      ...
      var invalid = [];
      var ergx = [];
      var err_minNoV = props.minNo !== undefined && (0, _validators.intValid)(props.minNo) && (0, _validators.filterInt)(props.minNo) > e.length;
      var err_maxNoV = props.maxNo !== undefined && (0, _validators.intValid)(props.maxNo) && (0, _validators.filterInt)(props.maxNo) < e.length;
      var validate;
