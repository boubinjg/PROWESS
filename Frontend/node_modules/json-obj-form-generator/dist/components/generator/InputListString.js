...
exports.getValue = exports.getErrors = exports.InputListString = void 0;
...
var InputListString = /*#__PURE__*/function (_Component) {
  _inherits(InputListString, _Component);

  var _super = _createSuper(InputListString);

  function InputListString() {
    var _this;

    _classCallCheck(this, InputListString);
    ...
    _defineProperty(_assertThisInitialized(_this), "state", {
      gId: (0, _utils.idGenerator)(_this.props.jkey.prefix + "il-str" + _this.props.jkey.sufix),
      preloaded: false
    });
    ...
    _defineProperty(_assertThisInitialized(_this), "onDrop", function (e) {
      ...
      err.invalid = !(!err.warn_def || !err.err_minNo && !err.err_maxNo && !err.invalidArr.includes(true));
      err.err_req = this.props.required && val.length === 0 && err.err_minNo;
      var sinvalid = [];
...
exports.InputListString = InputListString;
  ...
  minLength: function minLength(props, propName, componentName) {
    if (props[propName] !== undefined) {
      ...
      if (props["maxLength"] !== undefined && props["maxLength"] < props[propName]) {
        return new Error("Invalid prop `".concat(propName, "` supplied to `").concat(componentName, "`. Value must be lower than maxlength."));
      }
    }
  },
  maxLength: function maxLength(props, propName, componentName) {
    if (props[propName] !== undefined) {
      ...
      if (props["minLength"] !== undefined && props["minLength"] > props[propName]) {
        return new Error("Invalid prop `".concat(propName, "` supplied to `").concat(componentName, "`. Value must be greater than minlength."));
      }
    }
  },
