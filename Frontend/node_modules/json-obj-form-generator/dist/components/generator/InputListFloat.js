...
exports.getValue = exports.getErrors = exports.InputListFloat = void 0;
...
var InputListFloat = /*#__PURE__*/function (_Component) {
  _inherits(InputListFloat, _Component);

  var _super = _createSuper(InputListFloat);

  function InputListFloat() {
    var _this;

    _classCallCheck(this, InputListFloat);
    ...
    _defineProperty(_assertThisInitialized(_this), "state", {
      gId: (0, _utils.idGenerator)(_this.props.jkey.prefix + "il-float" + _this.props.jkey.sufix),
      preloaded: false
    });
    ...
    _defineProperty(_assertThisInitialized(_this), "onChange", function (e) {
      ...
      switch (e.target.name) {
        case "value-new":
          ...
          err.new_value = err.new_type && e.target.value.length > 0 ? (0, _validators.filterFloat)(String(e.target.value)) : e.target.value;
          break;
        ...
        default:
          ...
          val[idx] = err.etype[idx] && e.target.value.length > 0 ? (0, _validators.filterFloat)(String(e.target.value)) : e.target.value;
      }
  ...
  return InputListFloat;
}(_react.Component);

exports.InputListFloat = InputListFloat;

var valid = function valid(value, props) {
  var valid = [];
  var iValue = (0, _validators.filterFloat)(String(value));
  var validValue = (0, _validators.floatValid)(String(value));
...
InputListFloat.propTypes = {
  ...
  value: _propTypes.default.arrayOf(function (props, propName, componentName) {
    if (props[propName] !== undefined) {
      if (!(0, _validators.floatValid)(String(props[propName]))) {
        return new Error("Invalid prop `".concat(propName, "` supplied to `").concat(componentName, "`. Value must be float."));
      }
    }
  }),
