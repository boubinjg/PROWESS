...
exports.rebuild = exports.prototype = exports.valid = exports.clean = exports.InputColor = void 0;
...
var InputColor = /*#__PURE__*/function (_Component) {
  ...
  function InputColor() {
    ...
    _defineProperty(_assertThisInitialized(_this), "state", {
      isOpenMain: true,
      gId: (0, _utils.idGenerator)(_this.props.jkey.prefix + "color" + _this.props.jkey.sufix)
    });
    ...
    value: function render() {
      ...
      if (this.props.value.required) {
        default_section = /*#__PURE__*/_react.default.createElement(_reactstrap.Col, {
          ...
          invalid: this.props.value.default.length > 0 && !(0, _validators.isRGB)(this.props.value.default),
          ...
          invalid: this.props.value.default.length > 0 && !(0, _validators.isRGB)(this.props.value.default),
          bsSize: this.props.size
        }), this.props.value.default.length > 0 && !(0, _validators.isRGB)(this.props.value.default) ? /*#__PURE__*/_react.default.createElement(_reactstrap.FormFeedback, {
          valid: false
        }, this.props.translation.messages.type) : null)));
      }

      return /*#__PURE__*/_react.default.createElement("div", {
        className: this.props.className + " jofgen-D-card jofgen-D-color" + (this.props.value.required ? " required" : "") + (invalid || this.props.invalid ? " invalid" : ""),
        ...
        onChange: this.onChange,
        invalid: this.props.value.value.length > 0 && !(0, _validators.isRGB)(this.props.value.value),
        bsSize: this.props.size
      }), /*#__PURE__*/_react.default.createElement(_reactstrap.Input, {
        name: "value",
        type: "color",
        ...
        invalid: this.props.value.value.length > 0 && !(0, _validators.isRGB)(this.props.value.value),
        bsSize: this.props.size
      }), this.props.value.value.length > 0 && !(0, _validators.isRGB)(this.props.value.value) ? /*#__PURE__*/_react.default.createElement(_reactstrap.FormFeedback, {
        valid: false
      }, this.props.translation.messages.type) : null))), default_section))), /*#__PURE__*/_react.default.createElement(_react.Fragment, null, /*#__PURE__*/_react.default.createElement(_ErrorContainer.default, {
        jkey: {
...
InputColor.propTypes = {
  ...
  value: _propTypes.default.shape({
    ...
    value: function value(props, propName, componentName) {
      if (props[propName] !== undefined) {
        if (!(0, _validators.isRGB)(String(props[propName]))) {
          return new Error("Invalid prop `".concat(propName, "` supplied to `").concat(componentName, "`. Value must have format #ffffff."));
        }
      }
    },
  ...
  translation: _propTypes.default.shape(_propTypes2.BasicTypeTranslationPropType),
...
InputColor.defaultProps = {
  className: "",
  translation: _propTypes2.Default_ColorTranslation,
  invalid: false,
  icons: {
    icon: _icons.color,
    invalid_icon: _icons.invalid_color,
    errors: _icons.error,
...
var clean = function clean(e) {
  return Object.assign({}, {
    ...
    required: e.required
  } : null, e.value.length > 0 && (0, _validators.isRGB)(e.value) ? {
    value: e.value
  } : null, e.required && e.default.length > 0 && (0, _validators.isRGB)(e.default) && e.required ? {
    default: e.default
  } : null, e.err_req.length > 0 && e.required ? {
    err_req: e.err_req
  } : null, e.err_type.length > 0 ? {
    err_type: e.err_type
  } : null, e.required && e.warn_def.length > 0 && e.default.length > 0 && (0, _validators.isRGB)(e.default) && e.required ? {
    warn_def: e.warn_def
...
var valid = function valid(e) {
  return e.uid.length > 0 && (e.value.length === 0 || e.value.length > 0 && (0, _validators.isRGB)(e.value)) && (e.default.length === 0 || !e.required || e.required && e.default.length > 0 && (0, _validators.isRGB)(e.default));
};
