...
exports.rebuild = exports.prototype = exports.clean = exports.valid = exports.InputListInteger = void 0;
...
var _ListNumeric = require("./subcomponents/ListNumeric");
...
var InputListInteger = /*#__PURE__*/function (_Component) {
  ...
  function InputListInteger() {
    ...
    _defineProperty(_assertThisInitialized(_this), "onChange", function (e) {
      ...
      if (["min", "max", "minNo", "maxNo"].includes(e.target.name)) {
        props.value = (0, _ListNumeric.validGetArrays)(props.value, props, _validators.intValid, _validators.filterInt);
        props.default = (0, _ListNumeric.validGetArrays)(props.default, props, _validators.intValid, _validators.filterInt);
      }
  ...
  _createClass(InputListInteger, [{
    ...
    value: function render() {
      ...
      var fmax = (0, _validators.filterInt)(this.props.value.max);
      var fmin = (0, _validators.filterInt)(this.props.value.min);
      var mnL = (0, _validators.intValid)(this.props.value.min);
      var mxL = (0, _validators.intValid)(this.props.value.max);
      ...
      if (this.props.value.required) {
        ...
        }, /*#__PURE__*/_react.default.createElement(_subcomponents.ListNumeric, {
          uid: "default",
          value: this.props.value.default,
          onChange: this.onChangeList,
          min: (0, _validators.intValid)(this.props.value.min) && rangeValid && fmin >= 0 ? (0, _validators.filterInt)(this.props.value.min) : undefined,
          max: (0, _validators.intValid)(this.props.value.max) && rangeValid && fmax >= 0 ? (0, _validators.filterInt)(this.props.value.max) : undefined,
          minNo: (0, _validators.intValid)(this.props.value.minNo) && rangeNoValid && fminNo >= 0 ? (0, _validators.filterInt)(this.props.value.minNo) : undefined,
          maxNo: (0, _validators.intValid)(this.props.value.maxNo) && rangeNoValid && fmaxNo >= 0 ? (0, _validators.filterInt)(this.props.value.maxNo) : undefined,
          typeValid: _validators.intValid,
          typeFilter: _validators.filterInt,
      ...
      return /*#__PURE__*/_react.default.createElement("div", {
        className: this.props.className + " jofgen-D-card jofgen-D-ilInt" + (this.props.value.required ? " required" : "") + (invalid || this.props.invalid ? " invalid" : ""),
        ...
        size: this.props.size,
        className: "jofgen-D-inputLabel"
      }, this.props.translation.min), /*#__PURE__*/_react.default.createElement(_reactstrap.Col, {
        className: "jofgen-D-input-col"
      }, /*#__PURE__*/_react.default.createElement(_reactstrap.Input, {
        name: "min",
        type: "text",
        ...
        bsSize: this.props.size
      }), !rangeValid ? /*#__PURE__*/_react.default.createElement(_reactstrap.FormFeedback, {
        valid: false
      }, this.props.translation.messages.max) : null, isNaN(fmin) ? /*#__PURE__*/_react.default.createElement(_reactstrap.FormFeedback, {
        valid: false
      }, this.props.translation.messages.type) : null))), /*#__PURE__*/_react.default.createElement(_reactstrap.Col, {
        sm: 6
      }, /*#__PURE__*/_react.default.createElement(_reactstrap.FormGroup, {
        row: true
      }, /*#__PURE__*/_react.default.createElement(_reactstrap.Label, {
        ...
        size: this.props.size,
        className: "jofgen-D-inputLabel"
      }, this.props.translation.max), /*#__PURE__*/_react.default.createElement(_reactstrap.Col, {
        className: "jofgen-D-input-col"
      }, /*#__PURE__*/_react.default.createElement(_reactstrap.Input, {
        name: "max",
        type: "text",
        ...
        valid: false
      }, this.props.translation.messages.min) : null, isNaN(fmax) ? /*#__PURE__*/_react.default.createElement(_reactstrap.FormFeedback, {
        valid: false
      }, this.props.translation.messages.type) : null))), /*#__PURE__*/_react.default.createElement(_reactstrap.Col, {
        sm: 6
      }, /*#__PURE__*/_react.default.createElement(_reactstrap.FormGroup, {
        ...
        valid: false
      }, this.props.translation.messages.zeroNo) : null, isNaN(fminNo) ? /*#__PURE__*/_react.default.createElement(_reactstrap.FormFeedback, {
        valid: false
      }, this.props.translation.messages.typeNo) : null))), /*#__PURE__*/_react.default.createElement(_reactstrap.Col, {
        sm: 6
      }, /*#__PURE__*/_react.default.createElement(_reactstrap.FormGroup, {
        row: true
      }, /*#__PURE__*/_react.default.createElement(_reactstrap.Label, {
        ...
        valid: false
      }, this.props.translation.messages.minNo) : null, fmaxNo < 0 ? /*#__PURE__*/_react.default.createElement(_reactstrap.FormFeedback, {
        valid: false
      }, this.props.translation.messages.zeroNo) : null, isNaN(fmaxNo) ? /*#__PURE__*/_react.default.createElement(_reactstrap.FormFeedback, {
        valid: false
      }, this.props.translation.messages.typeNo) : null)))))), /*#__PURE__*/_react.default.createElement(_react.Fragment, null, /*#__PURE__*/_react.default.createElement(_ErrorContainer.default, {
        size: this.props.size,
        jkey: {
        ...
        values: Object.assign({}, this.props.value.required ? {
          ...
          err_min: this.props.value.err_min
        } : null, err_max ? {
          err_max: this.props.value.err_max
        } : null, err_minNo ? {
...
InputListInteger.propTypes = {
  ...
  value: _propTypes.default.shape({
    ...
    value: _propTypes.default.exact({
      ...
      new_min: _propTypes.default.bool.isRequired,
      new_max: _propTypes.default.bool.isRequired,
      new_type: _propTypes.default.bool.isRequired,
      values: _propTypes.default.arrayOf(_propTypes.default.oneOfType([_propTypes.default.string, _propTypes.default.number])).isRequired,
      emin: _propTypes.default.arrayOf(_propTypes.default.bool).isRequired,
      emax: _propTypes.default.arrayOf(_propTypes.default.bool).isRequired,
  ...
  translation: _propTypes.default.shape(_propTypes2.ListIntegerTranslationPropType),
...
InputListInteger.defaultProps = {
  className: "",
  translation: _propTypes2.Default_ListIntegerTranslation,
  invalid: false,
  icons: {
...
var valid = function valid(e) {
  ...
  var fminL = (0, _validators.filterInt)(e.min);
  var fmaxL = (0, _validators.filterInt)(e.max);
  var vdl = e.default.values.length;
  var vvl = e.value.values.length;
  var vml = (0, _validators.intValid)(e.min);
  var vmxl = (0, _validators.intValid)(e.max);
  var vm = (0, _validators.intValid)(e.minNo);
  var vmx = (0, _validators.intValid)(e.maxNo);
  return e.uid.length > 0 && (e.min.length === 0 || vml) && (e.max.length === 0 || vmxl) && (vml && vmxl && fminL <= fmaxL || !vml || !vmxl) && (e.minNo.length === 0 || vm) && (e.maxNo.length === 0 || vmx) && (vm && vmx && fmin <= fmax || !vm || !vmx) && ((vdl <= fmax || !fmax) && validDefault && (vdl >= fmin || !fmin) || vdl === 0 || !e.required) && ((vvl <= fmax || !fmax) && validValue && (vvl >= fmin || !fmin) || vvl === 0);
};
...
var clean = function clean(e) {
  var validDefault = !e.default.emin.includes(false) && !e.default.emax.includes(false) && !e.default.etype.includes(false);
  var validValue = !e.value.emin.includes(false) && !e.value.emax.includes(false) && !e.default.etype.includes(false);
  var minL = (0, _validators.filterInt)(e.min);
  var maxL = (0, _validators.filterInt)(e.max);
  ...
  var minLValid = (0, _validators.intValid)(e.min) && (maxL >= minL || isNaN(maxL));
  var maxLValid = (0, _validators.intValid)(e.max) && (maxL >= minL || isNaN(minL));
  return Object.assign({}, {
    ...
    err_req: e.err_req
  } : null, e.err_min.length > 0 && minLValid ? {
    err_min: e.err_min
  } : null, e.err_max.length > 0 && maxLValid ? {
    err_max: e.err_max
...
var prototype = function prototype() {
  return {
    ...
    name: "",
    required: false,
    value: (0, _ListNumeric.prototype)(),
    default: (0, _ListNumeric.prototype)(),
    min: "",
    max: "",
    minNo: "",
    maxNo: "",
...
var rebuild = function rebuild(e) {
  return {
    ...
    value: e.value !== undefined && e.value !== null ? (0, _ListNumeric.rebuild)(e.value, e, _validators.intValid, _validators.filterInt) : (0, _ListNumeric.prototype)(),
    default: e.default !== undefined && e.default !== null ? (0, _ListNumeric.rebuild)(e.default, e, _validators.intValid, _validators.filterInt) : (0, _ListNumeric.prototype)(),
